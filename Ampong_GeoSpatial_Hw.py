...
ax.set_title('Other Health Amenties in Cebu', fontsize=15)
ax.axis('off');
print("Other Health Amenity count in Cebu:", cebu_other.osm_id.count())
...
ax.axis('off');
print("Clinic count in Cebu:", cebuclinic.osm_id.count())
...
ax.axis('off');
print("Dentist count in Cebu:", cebudentist.osm_id.count())
...
ax.axis('off');
print("Doctor count in Cebu:", cebudoctor.osm_id.count())
...
ax.axis('off');
print("Hospital count in Cebu:", cebuhospital.osm_id.count())
...
ax.axis('off');
print("Pharmacy count in Cebu:", cebupharmacy.osm_id.count())
...
axs[0, 0].set_title('Health Aminity in Metro Manila', fontsize=15)
axs[0,0].axis('off');
...
axs[1,0].set_title('Health Aminity: Doctor in Metro Manila', fontsize=15)
axs[1,0].axis('off');
...
axs[1,1].set_title('Healthcares in Metro Manila', fontsize=15)
axs[1,1].axis('off');
...
cavite.plot( ax =axs[2, 1],color='white', edgecolor='dimgray')
cav_other.plot(ax=axs[2, 1], column="amenity", alpha=0.35, legend=True)
axs[2, 1].set_title('Other Health Aminities in Cavite', fontsize=15)
axs[2, 1].axis('off');




cavite.plot( ax =axs[2, 2],color='white', edgecolor='dimgray')
cavclinic.plot(ax=axs[2, 2], column="amenity", alpha=0.35, legend=True)
axs[2, 2].set_title('Clinics in Cavite', fontsize=15)
axs[2, 2].axis('off');



cavite.plot( ax =axs[3, 0],color='white', edgecolor='dimgray')
cavdentist.plot(ax=axs[3, 0], column="amenity", alpha=0.35, legend=True)
axs[3, 0].set_title('Dentist in Cavite', fontsize=15)
axs[3, 0].axis('off');

cavite.plot( ax =axs[3, 1],color='white', edgecolor='dimgray')
cavdoctor.plot(ax=axs[3, 1], column="amenity", alpha=0.35, legend=True)
axs[3, 1].set_title('Doctors in Cavite', fontsize=15)
axs[3, 1].axis('off');




cavite.plot( ax =axs[3, 2],color='white', edgecolor='dimgray')
cavpharmacy.plot(ax=axs[3, 2], column="amenity", alpha=0.35, legend=True)
axs[3, 2].set_title('Pharmacies in Cavite', fontsize=15)
axs[3, 2].axis('off');


cavite.plot( ax =axs[4, 0],color='white', edgecolor='dimgray')
cavhospital.plot(ax=axs[4, 0], column="amenity", alpha=0.35, legend=True)
axs[4, 0].set_title('Hospitals in Cavite', fontsize=15)
axs[4, 0].axis('off');


cebu.plot( ax =axs[4, 1],color='white', edgecolor='dimgray')
cebu_other.plot(ax=axs[4, 1], column="amenity", alpha=0.35, legend=True)
axs[4, 1].set_title('Other Health Amenties in Cebu', fontsize=15)
axs[4, 1].axis('off');



cebu.plot( ax =axs[4, 2],color='white', edgecolor='dimgray')
cebuclinic.plot(ax=axs[4, 2], column="amenity", alpha=0.35, legend=True)
axs[4, 2].set_title('Clinics in Cebu', fontsize=15)
axs[4, 2].axis('off');


cebu.plot( ax =axs[5, 0],color='white', edgecolor='dimgray')
cebudentist.plot(ax=axs[5, 0], column="amenity", alpha=0.35, legend=True)
axs[5, 0].set_title('Dentists in Cebu', fontsize=15)
axs[5, 0].axis('off');



cebu.plot( ax =axs[5, 1],color='white', edgecolor='dimgray')
cebudoctor.plot(ax=axs[5, 1], column="amenity", alpha=0.35, legend=True)
axs[5, 1].set_title('Doctors in Cebu', fontsize=15)
axs[5, 1].axis('off');


cebu.plot( ax =axs[5, 2],color='white', edgecolor='dimgray')
cebuhospital.plot(ax=axs[5, 2], column="amenity", alpha=0.35, legend=True)
axs[5, 2].set_title('Hospitals in Cebu', fontsize=15)
axs[5, 2].axis('off');


cebu.plot( ax=axs[6, 0],color='white', edgecolor='dimgray')
cebupharmacy.plot(ax=axs[6, 0], column="amenity", alpha=0.35, legend=True)
axs[6, 0].set_title('Pharmacies in Cebu', fontsize=15)
axs[6, 0].axis('off');